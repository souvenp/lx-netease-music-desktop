...
declare global {
  ...
  declare namespace LX {
    ...
    interface AppSetting {
      ...
      'common.navStatus': Partial<Record<LX.NavMenuId, boolean>>
       ...
       * 主界面背景图
       */
      'theme.background.enable': boolean
      'theme.background.image': string
      'theme.background.blur': number
      'theme.background.opacity': number
      'theme.background.dynamic': boolean

...
export const createDownload = ({
  ...
  if (!skipDefaultUserAgent && !Object.hasOwn(requestHeaders, 'User-Agent') && !Object.hasOwn(requestHeaders, 'user-agent')) {
    requestHeaders['User-Agent'] = 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36'
  }

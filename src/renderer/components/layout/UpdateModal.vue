    ...
    div.scroll.select(:class="$style.info")
      div(:class="$style.current")
        ...
        div(:class="$style.desc")
          ...
          p
            | 检查方法：打开
            base-btn(min aria-label="点击打开" @click="handleOpenUrl('https://github.com/souvenp/lx-netease-music-desktop/releases')") 软件发布页
            | ，查看「Latest」发布的
            strong 版本号
  ...
  main(v-else :class="$style.main")
    ...
    div(:class="$style.footer")
      div(:class="$style.desc")
        ...
        p 手动更新可以去&nbsp;
          strong.hover.underline(aria-label="点击打开" @click="handleOpenUrl('https://github.com/souvenp/lx-netease-music-desktop/releases')") 软件发布页
          | 下载。
        p 若遇到问题可以阅读

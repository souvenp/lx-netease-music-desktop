...
dd
  ...
  .gap-top
    base-checkbox(id="setting_download_writeAlias" :model-value="appSetting['download.writeAlias']" :label="$t('setting__download_write_alias')" @update:model-value="updateSetting({'download.writeAlias': $event})")
  .gap-top
